...
from .views import login_social, cambio_estado, agregar_tienda, eliminar_tienda, login_usuario, Home, contacto, registro, presupuesto, productos, cerrar, recovery, listado, agregar_lista, agregar_tienda_usuario, nuestros_productos
...
urlpatterns = [
    ...
    path('nuestrosproductos/', nuestros_productos, name="nuestros_productos"),
